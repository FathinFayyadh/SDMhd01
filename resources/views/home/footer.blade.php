				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-wiget wow fadeInUp" data-wow-delay="0.8s" data-wow-duration="1s">
						...
						<div class="footer-widget-photo">
							<ul>
								<li><img src="{{asset('assets/images/footer/footer1.png')}}" alt=""></li>
								<li><img src="{{asset('assets/images/footer/footer2.png')}}" alt=""></li>
								<li><img src="{{asset('assets/images/footer/footer3.png')}}" alt=""></li>
								<li><img src="{{asset('assets/images/footer/footer4.png')}}" alt=""></li>
								<li><img src="{{asset('assets/images/footer/footer5.png')}}" alt=""></li>
								<li><img src="{{asset('assets/images/footer/footer6.png')}}" alt=""></li>
							</ul>
						</div>
					</div>
				</div>
