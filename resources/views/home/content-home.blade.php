    ...
    <div class="container ">
      <div class="row  d-flex ">
        <div class="col-lg-6 align-items-center ">
          ...
          <p>Mencetak generasi unggul dengan kompetensi tinggi, berintegritas, berdaya saing, serta berkontribusi bagi masyarakat melalui pendidikan berkualitas.</p>
        </div>
        <div class="col-lg-6 text-center ">
          <!-- Mashead text and app badges-->
            <img src="{{ asset('landingpage/assets/img/school.png') }}" alt="" class="w-75  rounded-start rounded-end   ">
        </div>
      </div>
    </div>
  </header>
      ...
      <div class="row d-flex">
        ...
        <div class="col-xl-6">
          <div class="justify-content-center">
            <img
              src="{{ asset('landingpage/assets/img/about-profil.png') }}"
              alt=""
    ...
    <div class="container-fluid px-5">
      <div class="row d-flex">
        ...
        <div class="col-xl-6 mt-sm-5 mt-lg-0 mt-md-4">
          ...
          <div class=" fs-2 mb-4">
            <p> Melaksanankan Proses Pembelajaran Ilmu Agama  dan umum , membina kemampuan ,
              Keterampilan dan Bahasa Seni Rupa dan Olahraga , Menjalin Kerjasama dan harmonis baik internal maupun eksternal.</p>
        ...
        <div class="col-xl-6">
          ...
          <div class="justify-content-center">
            <img
              src="{{ asset('landingpage/assets/img/visi-misi.png') }}"
              alt=""
              class="w-100 rounded-4 shadow-lg"
            />
          </div>
