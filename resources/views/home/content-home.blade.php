...
@section('`title', 'SD Muhammadiyah 10 Medan')
						...
						<div class="slider-content">
							...
							<div class="main-btn slider1">
								<a href="about.html" class="nest-btn slider1">
									...
									<span class="nest-btn__shape slider"></span>
									<span class="nest-btn__shape slider"></span>
									<span class="nest-btn__text">Our Courses</span>
								</a>
							</div>
						</div>
					</div>
			...
			<div class="row align-items-center">
				<div class="col-lg-6 col-md-12">
					...
					<div class="help-main-title wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="1s">
						<h2>One Platfrom Many</h2>
						<h2>Courses You</h2>
					</div>
					<div class="help-list wow fadeInUp" data-wow-delay="0.6s" data-wow-duration="1s">
						<span><i class="bi bi-check"></i> Easy Online Learning Platform</span>
						<span><i class="bi bi-check"></i> 98% Course Completitation Rates</span>
						<span><i class="bi bi-check"></i> Friendly Enviroments & Teachers</span>
					</div>
				</div>
				<div class="col-lg-6 col-md-12">
				...
				<div class="col-lg-6 col-md-12">
					<div class="main-btn choose wow fadeInUp" data-wow-delay="0.4s" data-wow-duration="1s">
						<a href="about.html" class="nest-btn choose">
							...
							<span class="nest-btn__shape"></span>
							<span class="nest-btn__shape"></span>
							<span class="nest-btn__text"> View All <i class="bi bi-arrow-right"></i></span>
						</a>
					</div>
				</div>
			</div>
				...
				<div class="col-lg-6 col-md-12">
					<div class="choose-single-box wow fadeInUp" data-wow-delay="0.2s" data-wow-duration="1s">
						...
						<div class="choose-content">
							...
							<h4>The Complete Salesforce To
								Classic Certification</h4>
				...
				<div class="col-lg-6 col-md-12">
					<div class="intractor-single-box wow fadeInUp animated" data-wow-delay="600ms">
						<div class="instractor-content">
							<h4>Free Online Courses From
								School To Education</h4>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="section-title text-center wow fadeInUp animated" data-wow-delay="100ms">
						...
						<div class="section-main-title video">
			...
			<div class="row">
				<div class="column">
					<div class="testi-single-box wow fadeInUp animated" data-wow-delay="200ms">
						<div class="testi-thumb">
							...
							<div class="testi-content">
								...
								<p>Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusntium doemqe
					...
					<div class="testi-items-box two wow fadeInUp animated" data-wow-delay="400ms">
						<div class="testi-shape">
							<img src="assets/images/testimonial/testi-shape1.png" alt="">
						</div>
				...
				<div class="column">
					<div class="testi-items-box wow fadeInUp animated" data-wow-delay="600ms">
						<div class="testi-shape">
							<img src="assets/images/testimonial/testi-shape2.png" alt="">
						</div>
						<div class="testi-icon">
							<i class="bi bi-star-fill"></i>
							<i class="bi bi-star-fill"></i>
				...
				<div class="column">
					...
					<div class="testi-items-box two wow fadeInUp animated" data-wow-delay="1200ms">
						<div class="testi-shape">
							<img src="assets/images/testimonial/testi-shape3.png" alt="">
						</div>
						<div class="testi-icon">
							<i class="bi bi-star-fill"></i>
							<i class="bi bi-star-fill"></i>
	...
	<div class="blog-area">
		<div class="container">
			...
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<div class="blog-single-box wow fadeInUp animated" data-wow-delay="200ms">
						...
						<div class="blog-content">
							...
							<div class="blog-bottom">
								<div class="blog-comment">
									<h4><i class="bi bi-chat-right"></i> Comment (5)</h4>
								</div>
								<div class="blog-btn">
									<a href="blog-details.html">More <i class="bi bi-caret-right-fill"></i></a>
								</div>
							</div>
						</div>
					</div>
				...
				<div class="col-lg-6 col-md-12">
					<div class="blog-single-box wow fadeInUp animated" data-wow-delay="400ms">
						<div class="blog-thumb">
